...
public class RegistroUsuario extends AppCompatActivity {
    ...
    Button btnregistrarusaurio;
    EditText etA_Paterno, etA_Materno, etNombre, etTelefono, etCorreo, etContrasena1, etContrasena2;
    String contraseñaFinal;
    RequestQueue requestQueue;
    String URL = "https://primordial-recordin.000webhostapp.com/insertarusuario.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etA_Paterno = (EditText) findViewById(R.id.etPaternoUsuario);
        etA_Materno = (EditText) findViewById(R.id.etMaternoUsuario);
        etNombre = (EditText) findViewById(R.id.etNombreUsuario);
        etTelefono = (EditText) findViewById(R.id.etTelefonoUsuario);
        etCorreo = (EditText) findViewById(R.id.etCorreoUsuario);
        etContrasena1 = (EditText) findViewById(R.id.etContraseña1Usuario);
        etContrasena2 = (EditText) findViewById(R.id.etContraseña2Usuario);


        btnregistrarusaurio = (Button) findViewById(R.id.btnRegistrarUsuario);



        btnregistrarusaurio.setOnClickListener(new View.OnClickListener() {
            @Override
